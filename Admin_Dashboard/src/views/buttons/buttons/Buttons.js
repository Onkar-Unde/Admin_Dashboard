    ...
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              The <code> & lt; CButton & gt; </code> component are designed for{' '}
              <code> & lt; button & gt; </code> , <code>&lt;a&gt;</code> or{' '}
              <code> & lt; input & gt; </code> elements(though some browsers may apply a slightly
              different rendering).{' '}
            </p>{' '}
            <p className="text-body-secondary small">
              If you & #39;re using <code>&lt;CButton&gt;</code> component as <code>&lt;a&gt;</code>{' '}
              elements that are used to trigger functionality ex. collapsing content, these links
              should be given a <code>role= & #34;button&# 34; </code> to adequately communicate
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <code> variant = & #34;outline&# 34; </code> prop to remove all background
              colors.{' '}
            </p>{' '}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              If you need a ghost variant of button, set <code> variant = & #34;ghost&# 34; </code>{' '}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Larger or smaller buttons ? Add <code> size = & #34;lg&# 34; </code> or{' '}
              <code> size = & #34;sm&# 34; </code> for additional sizes.{' '}
            </p>{' '}
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <code> pointer - events : none </code> applied to, disabling hover and active states
              from triggering.{' '}
            </p>{' '}
            ...
            <p className="text-body-secondary small">
              Disabled buttons using the <code> & lt; a & gt; </code> component act a little
              different:{' '}
            </p>{' '}
            <p className="text-body-secondary small">
              <code> & lt; a & gt; </code>s don&#39;tsupport the <code>disabled</code> attribute, so
              ...
              <code> aria - disabled = & #34;true&# 34; </code> attribute to show the state of the
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-body-secondary small">
              ...
              example, for a half - width & #34;block button&# 34;, use <code> .col - 6 </code>.
              Center it horizontally with <code> .mx - auto </code>, too.{' '}
            </p>{' '}
            <DocsExample href="components/buttons#block-buttons">
            ...
            <p className="text-body-secondary small">
              ...
              horizontal.Here we & #39;ve taken our previous responsive example and added some flex
              utilities and a margin utility on the button to right align the buttons when they&#
              39; re no longer stacked.{' '}
            </p>{' '}
            <DocsExample href="components/buttons#block-buttons">
