...
const FormControl = () => {
    return ( <
        ...
        the input & #39;s value. Read-only inputs appear lighter (just like disabled inputs),
        ...
        <
        p className = "text-body-secondary small" >
        If you want to have < code > & lt; input readonly & gt; < /code> elements in your form styled
