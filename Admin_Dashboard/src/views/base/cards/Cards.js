    ...
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              alignment and mix well with other CoreUI components.Cards have no top, left, and right
              margins by default, so use{' '}
              <a href="https://coreui.io/docs/utilities/spacing"> spacing utilities </a> as needed.
              They have no fixed width to start, so they & #39;ll fill the full width of its parent.
            </p>
            <p className="text-body-secondary small">
              Below is an example of a basic card with mixed content and a fixed width.Cards have no
              fixed width to start, so they & #39;ll naturally fill the full width of its parent
              element.
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              The main block of a card is the <code> & lt; CCardBody & gt; </code>. Use it whenever
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Card titles are managed by <code> & lt; CCardTitle & gt; </code> component.
              Identically, links are attached and collected next to each other by{' '}
              <code> & lt; CCardLink & gt; </code> component.{' '}
            </p>{' '}
            <p className="text-body-secondary small">
              Subtitles are managed by <code> & lt; CCardSubtitle & gt; </code> component. If the{' '}
              <code> & lt; CCardTitle & gt; </code> also, the <code>&lt;CCardSubtitle&gt;</code>{' '}
              items are stored in a <code> & lt; CCardBody & gt; </code> item, the card title, and
              subtitle are arranged rightly.{' '}
            </p>{' '}
              <CCard style={{ width: '18rem' }}>
                <CCardBody>
                  <CCardTitle> Card title </CCardTitle>{' '}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-body-secondary small">
              Card headers can be styled by adding ex. <code> as = & #34;h5&# 34; </code>.{' '}
            </p>{' '}
              <CCard>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              unless otherwise stated.You can adjust this as required with custom CSS, grid classes,
              grid Sass mixins, or services.{' '}
            </p>{' '}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Add some navigation to a <code> & lt; CCardHeader & gt; </code> with our{' '}
              <code> & lt; CNav & gt; </code> component.{' '}
            </p>{' '}
           <CCard className="text-center">
                <CCardHeader>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              Similar to headers and footers, cards can include top and bottom & #34;image caps&#
              34;— images at the top or bottom of a card.{' '}
            </p>{' '}
              <CRow>
                <CCol lg={6}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <h3>Border</h3>
            <p className="text-body-secondary small">
              Use <a href="https://coreui.io/docs/utilities/borders/"> border utilities </a> to
              change just the <code> border - color </code> of a card. Note that you can set{' '}
              <code> textColor </code> property on the <code>&lt;CCard&gt;</code> or a subset of the
              card & #39;s contents as shown below.
            </p>
              <CRow>
                {' '}
                {[
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              become attached with uniform dimensions starting at the <code> sm </code>{' '}
              breakpoint.{' '}
            </p>{' '}
              <CCardGroup>
                <CCard>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <code>
                {' '}
                & #123;xs|sm|md|lg|xl|xxl&# 125; = & #123;&# 123; cols: * & #125;&# 125;{' '}
              </code>{' '}
              property to control how many grid columns(wrapped around your cards) you show per
              row.For example, here & #39;s <code>
                xs= & #123;&# 123; cols: 1 & #125;&# 125;{' '}
              </code>{' '}
              laying out the cards on one column, and{' '}
              <code> md = & #123;&# 123; cols: 1 & #125;&# 125; </code> splitting four cards to
            ...
            <p className="text-body-secondary small">
              Change it to <code> md = & #123;&# 123; cols: 3 & #125;&# 125; </code> and you&#39;ll
