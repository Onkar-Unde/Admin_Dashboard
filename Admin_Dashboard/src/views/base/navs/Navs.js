...
const Navs = () => {
        return ( <
            ...
            foundation
            for building all types of navigation components.It includes some style overrides(
                for working with lists), some link padding
            ...
            code > & lt; ul & gt; < /code>s like above, <code>&lt;ol&gt;</code >
            if the order of your items is important, or roll your own with a { ' ' } <
            code > & lt; nav & gt; < /code> element. Because the.nav uses display: flex, the nav
            ...
            /a>
            .By
            default, navs are left - aligned, but you can easily change them to center or right aligned. { ' ' } <
            /p>{' '} <
            p className = "text-body-secondary small" >
            ...
            others ? Use the responsive versions(e.g., < code > .flex - sm - column < /code>).{' '} <
                ...
                <
                p className = "text-body-secondary small" >
                Takes the basic nav from above and adds the < code > variant = & #34;tabs&# 34; < /code>{' '}
                ...
                <
                p className = "text-body-secondary small" >
                Take that same HTML, but use < code > variant = & #34;pills&# 34; < /code> instead:{' '} <
                /p>{' '} <
                ...
                code > .nav - item < /code>s, use <code>layout=&#34;fill&#34;</code > .Notice that all horizontal space is occupied, but not every nav item has the same width. { ' ' } <
                /p>{' '} <
                ...
                /DocsExample>{' '} <
                p className = "text-body-secondary small" >
                For equal - width elements, use < code > layout = & #34;justified&# 34; < /code>. All
                horizontal space will be occupied by nav links, but unlike the.nav - fill above, every nav item will be the same width. { ' ' } <
                /p>{' '} <
                DocsExample href = "components/nav-tabs#fill-and-justify" >
                <
                CNav variant = "pills"
                ...
                verbose, these utilities offer greater customization across responsive breakpoints.In the example below, our nav will be stacked on the lowest breakpoint, then adapt to a horizontal layout that fills the available width starting from the small breakpoint. { ' ' } <
                /p>{' '} <
                ...
                CDropdownItem href = "#" > Something
                else here < /CDropdownItem>{' '} <
                    /CDropdownMenu>{' '} <
                    /CDropdown>{' '} <
                    CNavItem >
                    <
