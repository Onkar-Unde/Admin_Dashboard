...
const Typography = () => {
    return ( <
        ...
        for Bootstrap typography, including global settings,
        ...
        p >
        <
        code className = "highlighter-rouge" > & lt; h1 & gt; & lt;
        /h1&gt;</code >
        <
        /p> < /
        td > <
        ...
        p >
        <
        code className = "highlighter-rouge" > & lt; h2 & gt; & lt;
        /h2&gt;</code >
        <
        /p> < /
        td > <
        ...
        p >
        <
        code className = "highlighter-rouge" > & lt; h3 & gt; & lt;
        /h3&gt;</code >
        <
        /p> < /
        td > <
        ...
        p >
        <
        code className = "highlighter-rouge" > & lt; h4 & gt; & lt;
        /h4&gt;</code >
        <
        /p> < /
        td > <
        ...
        p >
        <
        code className = "highlighter-rouge" > & lt; h5 & gt; & lt;
        /h5&gt;</code >
        <
        /p> < /
        td > <
        ...
        p >
        <
        code className = "highlighter-rouge" > & lt; h6 & gt; & lt;
        /h6&gt;</code >
        <
        /p> < /
        td > <
        ...
        <
        p >
        Traditional heading elements are designed to work best in the meat of your page content.When you need a heading to stand out, consider using a < strong > display heading < /strong>—
        ...
        dd className = "col-sm-9" > A description list is perfect
        for defining terms. < /dd>
